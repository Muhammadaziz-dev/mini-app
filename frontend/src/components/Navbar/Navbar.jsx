...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    <div className="navbar">
      <Link to="/">
        <img src={assets.logo || "/placeholder.svg"} alt="Food Del" className="logo" />
      </Link>
      ...
      <div className="navbar-right">
        ...
        <div className="navbar-search-icon">
          <Link to="/cart">
            <img className="basketlogo" src={assets.basket_icon || "/placeholder.svg"} alt="" />
          </Link>
        ...
        {!token ? (
          ...
          <div className="navbar-profile">
            <img src={assets.profile_icon || "/placeholder.svg"} className="white-filter" alt="" />
            <ul className="nav-profile-dropdown">
              <li onClick={() => navigate("/myorders")}>
                <img src={assets.bag_icon || "/placeholder.svg"} alt="" />
                <p>Orders</p>
              </li>
              {/* Add admin link for demo purposes */}
